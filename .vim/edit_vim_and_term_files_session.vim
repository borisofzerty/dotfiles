...
map éOB :resize -5
map éOA :resize +5
map é<S-Left> :vertical resize -1
map é<S-Right> :vertical resize +1
map éOD :vertical resize -5
map éOC :vertical resize +5
map éj :jumps
map ém :marks
map ér :registers
map é. :
...
set shortmess=aoO
badd +1 bubblegum.vim
badd +0 ~/.vimrc
badd +0 ~/.Xresources
args bubblegum.vim ~/.vimrc ~/.Xresources
set lines=72 columns=157
edit ~/.vimrc
...
exe '1resize ' . ((&lines * 58 + 36) / 72)
exe 'vert 1resize ' . ((&columns * 78 + 78) / 157)
exe '2resize ' . ((&lines * 11 + 36) / 72)
